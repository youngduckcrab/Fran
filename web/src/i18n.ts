...
const ko = {
  ...
  'settings.aboutHint': '번역할 때 참고해요. 스페인어는 "cansado / cansada" 처럼 성에 따라 말이 달라지고, 같은 말도 칠레와 스페인이 달라요.',
  ...
  'search.hint': '원문과 번역문, 음성을 받아쓴 글에서 함께 찾아요. 어느 언어로 쳐도 돼요.',
  'search.looking': '찾는 중…',
...
const es: Record<StringKey, string> = {
  ...
  'settings.viewHint': 'Elijas lo que elijas, tocando el mensaje aparece el resto.',
  'view.translation': 'Solo traducción',
  'view.both': 'Original + traducción',
  'view.source': 'Solo original',

  'settings.about': 'Sobre mí',
  'settings.aboutHint': 'Se usa al traducir. En español cambia según el género ("cansado / cansada"), y no se habla igual en Chile que en España.',
  ...
  'search.hint': 'Busca en el original, en la traducción y en lo transcrito. En cualquier idioma.',
...
const en: Record<StringKey, string> = {
  ...
  'settings.aboutHint': 'Used when translating. Spanish changes with gender ("cansado / cansada"), and Chile does not speak it like Spain.',
  ...
  'search.hint': 'Searches the original, the translation and voice transcripts. Any language.',
